...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject also means reduce, it convert the whole array into a single object as per some algorithm.
  end
  ...
  # When calling File.open with a block, it will automatically close the file for you,
